...
class ColorSchemes {
  static ColorScheme lightZinc() {
    return ColorScheme(
      ...
      chart6: const HSLColor.fromAHSL(1, 12.0, 0.76, 0.61).toColor(),
      chart7: const HSLColor.fromAHSL(1, 173.0, 0.58, 0.39).toColor(),
      chart8: const HSLColor.fromAHSL(1, 197.0, 0.37, 0.24).toColor(),
      chart9: const HSLColor.fromAHSL(1, 43.0, 0.74, 0.66).toColor(),
      chart10: const HSLColor.fromAHSL(1, 27.0, 0.87, 0.67).toColor(),
    );
  }
